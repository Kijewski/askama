...
* 1st) relative to the including template's path
* 2nd) in the directories specified in the [configuration](configuration.md)
* 3th) in the folder of the file that contains the `#[derive(Template)]` annotation.
